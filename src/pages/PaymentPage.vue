<template>
  <div class="q-pa-md">
    <div class="row">
      <div class="col-12">
        <transition appear enter-active-class="animated slower fadeInLeft" leave-active-class="fadeInLeft">
          <p class="bg-white text-h5 q-pa-md text-weight-bold shadow-5">This is After Payment Page...</p>
        </transition>
